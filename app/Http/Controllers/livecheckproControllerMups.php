...
class livecheckproControllerMups extends Controller {
    use Traits\CommonlyUsedFunctions;


    public function page() {
        return view('livecheckproMups.index')->with('modal', 0);
    }


    public function leaflet() {
        return view('livecheckproMups.leaflet');
    }


    public function mlivecheck( Request $request ) {
        // return $request->all();
        ...
        if ( is_numeric($phone_number) )
        {
            if (strlen($phone_number) > 11) {
                ...
                return view('livecheckproMups.response_page')->with([
                    'response'  => $response,
                    'modal'  => 1,
                ]);
            }
