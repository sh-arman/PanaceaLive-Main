		...
		<div class="row">
			<div class="col-md-4">
				<div class="col-md-12 thumbnail text-center">
					<img alt="Medicine back" style="width: 100%; height: auto" class="img-responsive" src="{{asset('frontend/images/how-1.png')}}">
			...
			<div class="col-md-4">
				<div class="col-md-12 thumbnail text-center">
					<img alt="Phone display" style="width: 100%; height: auto" class="img-responsive" src="{{asset('frontend/images/how-2.png')}}">
			...
			<div class="col-md-4">
				<div class="col-md-12 thumbnail text-center">
					<img alt="Phone and medicine" style="width: 100%; height: auto" class="img-responsive" src="{{asset('frontend/images/how-3.png')}}">
		...
		<div class="row justify-centent-center">
			<div class="col-md-12">
				<span data-toggle="tooltip" title="Essilor corrects, protects and prevents
					...
					<img src="{{asset('frontend/images/essilor.png')}}" style="max-width:300px;" alt="Essilor"></span>
			</div>
		</div>
	</div>
</div>
...
@section('scripts')
	@parent
	<script type="text/javascript" src="{{asset('frontend/js/tympanus-medicine/imagesloaded.pkgd.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('frontend/js/tympanus-medicine/masonry.pkgd.min.js')}}"></script>
	<script type="text/javascript" src="{{asset('frontend/js/tympanus-medicine/classie.js')}}"></script>
	<script type="text/javascript" src="{{asset('frontend/js/tympanus-medicine/cbpGridGallery.js')}}"></script>
	<script>
