    ...
    <div class="container">
        <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand" href="{{ route('home') }}">
                <img src="{{ asset('frontend/images/logo.PNG') }}" alt="Panacea Live Logo">
            </a>
        </div>
                ...
                <li>
                    <div class="dropdown">
                        <button class="dropbtn">
                            SERVICES
                            <img style="max-width:15px;margin-left:5px;" src="{{asset('frontend/images/dropdown.png')}}">
                        </button>
                        <div class="dropdown-content">
                            <a href="{{ route('home') }}">Live Check</a>
                        ...
                        <table style="margin-top:10px">
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a href="{{ route('legal') }}" target="_blank"  style="color:#2e53b9;">
