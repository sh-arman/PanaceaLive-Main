@extends('livecheckproMups.master')
@section('content-box')
{{-- modal --}}
...
<div class="content-box">
    ...
    <form method="POST" action="{{ route('mupslivecheck') }}">
        ...
        <div class="row justify-content-center">
            {{-- Back Button --}}
            <button type="button" id="back" class="btnverify" style="display:none;" >{{trans('literature.button-back')}}</button>
            {{-- Next Button --}}
            <button type="button" id="nextOne" class="btnverify" >{{trans('literature.button-next')}}</button>
            {{-- Submit Button --}}
            <button type="submit" id="nextTwo" class="btnverify" style="display:none;">{{trans('literature.button-verify')}}</button>
        </div>
    </form>
</div>
@endsection
