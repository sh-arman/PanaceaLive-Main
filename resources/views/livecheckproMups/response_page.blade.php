    ...
    <div class="content mb-4">
        <div class="container">
                    ...
                    @elseif ($response['status'] == 'already verified')
                        ...
                        <div id="warningMsg">
                          <div class="warning" style="width: 90% !important;">
                            <p style="font-size: .9rem !important;">{{ trans('literature.warning-paragraph') }}</p>
          ...
          <div class="row justify-content-center mb-4">
            <a href="{{ route('mups') }}">
              <button type="submit" id="donebtn" class="btnverify" >{{trans('literature.button-done')}}</button>
            </a>
          </div>
        </div>
    </div>
