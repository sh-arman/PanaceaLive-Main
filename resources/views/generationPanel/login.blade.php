            ...
            <div class="row">
                <div class="col-md-4 col-md-offset-4">
                    <div id="login_div" style="display: block">
                        <h3 style="text-align: center; text-transform: capitalize">{{ $company }} </h3>
                        <br>
                        <p id="error_msg"></p>
                        ...
                        <div id="verify_div" style="display: none">
                            <h4 id="checkMessage" style="text-align: center">
                                ...
                                {{-- A  code has been sent to your phone number & email. --}}
                            </h4>
                            ...
                            <input type="hidden" id="userid" name="id" value="{{ session()->get('id') }}">
                            <meta name="csrf-token" content="{{ csrf_token() }}">
                            <meta name="csrf-token_verify" content="{{ csrf_token() }}">
...
<script type="text/javascript" src="{{ asset('js/generationpanel.js') }}"></script>
<script>
    $("#resend_code").click(function(){
        ...
        $.post("/resend", {id: id,_token: "{{ csrf_token() }}"}, function (data) {
            var a = data;
            $("#session_msg").html(a);
        });
    });
